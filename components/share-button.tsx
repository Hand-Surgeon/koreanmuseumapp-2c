...
export function ShareButton({
  ...
  const shareTitle = artifact.name[language as keyof typeof artifact.name]
  const shareText = `${shareTitle} - ${t.nationalMuseum} ${t.shareTitle}`
    ...
    if (navigator.share) {
      try {
        ...
        if ((err as Error).name !== 'AbortError') {
          console.error(t.shareFailed, err)
        }
      }
    }
  }
