...
import { getHallSlug } from "@/lib/hall-utils"
...
export default function HomePage() {
  ...
  const filteredArtifacts = searchTerm
    ? filterArtifacts(artifacts, searchTerm, t.all, language as 'ko' | 'en' | 'zh' | 'ja' | 'th', t.all)
    : []
        ...
        {!searchTerm && (
          <>
            <div className="mb-8">
              ...
              <div className="grid grid-cols-2 gap-4" data-testid="featured-artifacts">
