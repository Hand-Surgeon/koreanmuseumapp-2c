...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      siteName: (metadata[locale].title as any).default,
      title: (metadata[locale].title as any).default,
      description: metadata[locale].description as string,
      images: [
        {
          url: "/og-image.jpg",
          width: 1200,
          height: 630,
          alt: (metadata[locale].title as any).default,
        }
      ]
    },
    alternates: {
